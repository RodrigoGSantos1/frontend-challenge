...
export const useCartActions = () => {
  ...
  const handleAddItem = (props: CartItemType) => dispatch(addItem(props));
  ...
  const isOverviewVisible = useSelector(
    (state: RootState) => state.cart.isOverviewVisible,
  );
